...
<Grid continer>
            ...
            <Grid item xs={12} md={12}>
              ...
              />
              {errors.name && <p style={{color:"#E8D73F", marginTop:3, marginBottom:2}}>Please check the Product Name</p>}
            ...
            <Grid item xs={12} md={12}>
              ...
              />
              {errors.description && <p style={{color:"#E8D73F", marginTop:3, marginBottom:2}}>Please check the Product Description</p>}
